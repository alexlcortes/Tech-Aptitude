...
var questions = [{
  ...
  answers: ["Personal Hypertext Processor", "PHP; Hypertext Processor", "Private Home Page", "Private Hypertext Homepage"],
  correctAnswer: "PHP; Hypertext Processor"
}, {
  question: "PHP server scripts are surrounded by delimiters, which?",
  answers: ["<?php>...</?>", "<&>...</&>", "<script>...</script>", "	<?php...?>"],
  correctAnswer: "<?php>...</?>"
